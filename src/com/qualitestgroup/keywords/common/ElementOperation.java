...
public class ElementOperation {
	 ...
	 * @throws KDTKeywordExecException
	 */
	public List<WebElement> returnWebElementsAfterReplacingMultipleKeyValue(WebDriver driver, String property,
	 ...
	 * @throws KDTKeywordExecException
	 */
	public void enterText(WebDriver driver, String property, String keyValue, String data, String errorMsg,
		...
		try {
			...
			throw new KDTKeywordExecException("In User is not able to enter text in : <b>" + errorMsg + " Textbox ----"
					+ "WebElement <b>" + elementIdentifier + "<b> is not clickable/found \n");
		}
	}
	...
	public String getTextThroughLocator(WebDriver driver, String locator, String identifier, String application)
			throws Exception {
	 ...
	 * @throws KDTKeywordExecException
	 */
	public boolean isDisplayedAfterReplace(WebDriver driver, String property, String keyValue, String oldChar,
			String newChar, String application) throws KDTKeywordExecException {
	...
	public void checkCheckBoxAfterReplacingKeyValue(WebDriver driver, String property, String keyValue, String oldChar,
			String newChar, String application) throws KDTKeywordExecException {
		eo.wait(2);
		String elementIdentifier = gei.getProperty(keyValue, application);
		elementIdentifier = elementIdentifier.replace(oldChar, newChar);
	...
	public void waitForPageLoad(WebDriver driver, int pageLoadTime) {
	 ...
	 * @throws KDTKeywordExecException
	 */
	public void javaScriptScrollToViewElementAfterReplace(WebDriver driver, String property, String keyValue,
			String oldChar, String newChar, String application) throws KDTKeywordExecException

	{
		...
		try {
			...
			// throw new KDTKeywordExecException("Not able to scroll on an element using
			// javascript having xpath - <b>" + elementIdentifier + "</b>",e);
		}
	}
	...
	public By getListOfWebElementByLocator(WebDriver driver, String locator, String elementIdentifier)
		...
		// Wait for all the web element to be displayed on the web page for 60 Seconds
		// of time
		try {
	 ...
	 * @throws KDTKeywordExecException
	 */
	public void actionClickAfterReplacingKeyValue(WebDriver driver, String property, String keyValue, String oldChar,
			String newChar, String application) throws KDTKeywordExecException {
	 ...
	 * @throws KDTKeywordExecException
	 */
	public void actionClickAfterReplacingMultipleKeyValue(WebDriver driver, String property, String keyValue,
			String searchList[], String replacementList[], String application) throws KDTKeywordExecException {
		Actions action = new Actions(driver);
		String elementIdentifier = gei.getProperty(keyValue, application);
		elementIdentifier = StringUtils.replaceEach(elementIdentifier, searchList, replacementList);
	 ...
	 * @throws KDTKeywordExecException
	 */
	public void actionClick(WebDriver driver, String property, String keyValue, String errorMsg, String application)
			throws KDTKeywordExecException {
		Actions action = new Actions(driver);
		String elementIdentifier = gei.getProperty(keyValue, application);
		By ele = getWebElementByLocator(driver, property, elementIdentifier);
		try {
			...
			throw new KDTKeywordExecException("<b> Not able to Mouse click the " + errorMsg + "WebElement <b>"
					+ elementIdentifier + "<b> is not clickable \n");
		}
	}
	...
	public void actionDoubleClickAfterReplacingKeyValue(WebDriver driver, String property, String keyValue,
			String oldChar, String newChar, String application) throws KDTKeywordExecException {
		Actions action = new Actions(driver);
		String elementIdentifier = gei.getProperty(keyValue, application);
		elementIdentifier = elementIdentifier.replace(oldChar, newChar);
	 ...
	 * @throws KDTKeywordExecException
	 */
	public void switchToFrameByXPath(WebDriver driver, String property, String keyValue, int timeout, String errorMsg,
			String application) throws KDTKeywordExecException {
		String elementIdentifier = gei.getProperty(keyValue, application);
		By ele = getWebElementByLocator(driver, property, elementIdentifier);
		try {
			...
			throw new KDTKeywordExecException(
					"Unable to Switch to the frame : <b>" + errorMsg + "<\b>" + "Waited for - <b>" + timeout
							+ "<\b> - Seconds \n" + "WebElement - <b>" + elementIdentifier + "<b> - not found \n");
		}
	}
	...
	public void selectElement(String property, String keyValue, String data, String application)
			throws KDTKeywordExecException {
		try {
	...
	public void SetCheckBox(String property, String keyValue, String data, String application)
			throws KDTKeywordExecException {
		try {
			String eleIdentifier = gei.getProperty(keyValue, application);
			System.out.println(eleIdentifier);
	...
	public void verifyScreenText(WebDriver driver, String property, String keyValue, String verifyExpString,
			String application) throws KDTKeywordExecException {
		WebElement ele;
		String actualText = "";
		try {
	...
	public void executeJScriptThroughJsIdentifier(WebDriver driver, String jsIdentifier, String application)
			throws Exception {
		try {
	...
	public void setText(String property, String keyValue, String data, String application)
			throws KDTKeywordExecException {
		GetElementIdentifier gei = new GetElementIdentifier();
		try {
			String eleIdentifier = gei.getProperty(keyValue, application);
	...
	public String gnerateRandomNo(int digit) {
		/*
		 * Random rnd = new Random(); int min =(int) Math.pow(10,digit-1); int max =
		 * ((int) Math.pow(10,digit)-(int)Math.pow(10,digit-1)); int no = min +
		 * rnd.nextInt(max); return Integer.toString(no);
		 */
		String strTimeStamp = "";
		...
		return strTimeStamp.substring(strTimeStamp.length() - (digit + 1), strTimeStamp.length() - 1);
	}
	 ...
	 * @throws KDTKeywordExecException
	 */
	public void waitForWebElementVisible(WebDriver driver, String property, String keyValue, int timeout,
			String errorMsg, String application) throws KDTKeywordExecException {
		String elementIdentifier = gei.getProperty(keyValue, application);
		By ele = getWebElementByLocator(driver, property, elementIdentifier);
		...
		try {
			...
			throw new KDTKeywordExecException("<b>" + errorMsg + " is not displayed --- " + "Waited for <b>" + timeout
					+ "<\b> Seconds --- " + "WebElement <b>" + elementIdentifier + "<b> is not found \n");
		}
	}
	...
	public void waitForWebElementVisibleAfterReplace(WebDriver driver, String locator, String keyValue, String oldChar,
			String newChar, int timeout, String application) throws KDTKeywordExecException {
	...
	public boolean isExists(WebDriver driver, String property, String keyValue, String application)
		...
		boolean isExists;
		try {
			List<WebElement> elts = new WebDriverWait(driver, 150)
	...
	public boolean isExistsAfterReplace(WebDriver driver, String property, String keyValue, String oldChar,
		...
		// 150)).until(ExpectedConditions.elementToBeClickable(ele));
	 ...
	 * @throws KDTKeywordExecException
	 */
	public void selectComboBoxByVisibleTextAfterReplacingKeyValue(WebDriver driver, String property, String keyValue,
			String oldChar, String newChar, String selectvalue, String application) throws KDTKeywordExecException {
		String elementIdentifier = gei.getProperty(keyValue, application);
		elementIdentifier = elementIdentifier.replace(oldChar, newChar);
		System.out.println(elementIdentifier);
		try {
